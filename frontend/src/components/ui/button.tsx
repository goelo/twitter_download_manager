  ...
  return (
    <button
      className={cn(
        ...
        variant === 'default' && 'border-transparent bg-[linear-gradient(180deg,hsl(var(--primary))_0%,#2563eb_100%)] text-white shadow-[0_10px_28px_rgba(14,165,233,0.24)] hover:-translate-y-[1px] hover:shadow-[0_14px_34px_rgba(14,165,233,0.32)]',
