...
class ScheduleOperationsTest(unittest.TestCase):
    ...
    def test_schema_migrations_are_recorded_and_idempotent(self):
        ...
        self.assertEqual(int(row['value']), 9)
        ...
        with web_app.db() as conn:
            ...
            checkpoint_columns = {item['name'] for item in conn.execute('pragma table_info(schedule_collection_checkpoints)').fetchall()}
        ...
        self.assertIn('last_tweet_id', checkpoint_columns)
